...
export default function Home() {
  ...
  const CONTRACT_ADDRESSES = {
    ...
    SEPOLIA: {
      TOKEN: "0x35DdD28c68D86643dD3982a065e593F63252D218", // Update with actual Sepolia token address
      BRIDGE: "0xAbBf70A16433b3Fbc0611dE0a26fF9Fd927cD339"  // Update with actual Sepolia bridge address
    }
  };
  ...
  const handleBridge = async () => {
    ...
    try {
      ...
      toast.info("Approving tokens... Please wait", { autoClose: false, toastId: "approving" });
      ...
      toast.info("Bridging tokens... Please wait", { autoClose: false, toastId: "bridging" });
      
      // Determine which function to call based on the fromToken
      ...
      // Execute the appropriate bridge function
      const bridgeTx = await writeContractAsync({
        address: bridgeAddress as `0x${string}`,
        abi: BridgeSepoliaAbi.abi, // Consider using a conditional ABI here if they're different
      ...
      toast.success(`Successfully bridged ${amount} MTK tokens to ${toToken}!`);
      
    } catch (error) {
      toast.dismiss("approving");
      toast.dismiss("bridging");
      toast.error(`Error bridging tokens: ${(error as any).message?.split('(')[0] || (error as any).message || 'Unknown error'}`);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              >
                <option value="BASE">SEPOLIA</option>
                <option value="LINER">BASE</option>
              </select>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="LINER">SEPOLIA</option>
              </select>
            </div>
          </div>
